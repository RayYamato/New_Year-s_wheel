(() => {
  ...
  if(importSample) importSample.addEventListener('click', ()=> {
    const samples = ['1k','100k','mất lượt','5k','gấp đôi người trước','10k','thêm lượt','20k','chúc mừng năm mới','50k','hẹn năm sau','30k','lì xì lại chủ nhà 20k','2k','một nửa người trước','15k','tất cả vỗ tay','40k','lì xì lại chủ nhà 50k','200k','bốc phong bao bất kỳ','50k','lì xì lại chủ nhà 100k'];
